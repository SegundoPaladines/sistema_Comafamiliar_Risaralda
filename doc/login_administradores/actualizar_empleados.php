...
<body>
    ...
    <center>
        <form action="procesar_actualizar_empleados.php" method="post" id="fm1">
            <div id="contenedor_tabla_empleados">
                <center><h3> Lista de Empleados </h3></center>
                <center><table id="empleados">
                    ...
                    $id = $_GET["id"];
                    $empleados="SELECT *  FROM `empleados` WHERE id LIKE '$id'";

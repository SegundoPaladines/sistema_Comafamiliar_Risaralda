...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, nombres, apellidos, username, password FROM admins WHERE username = ?";
            ...
            <div id="log">
                <div class="caja1">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="formtlo ">Iniciar sesión: Administradores</div>

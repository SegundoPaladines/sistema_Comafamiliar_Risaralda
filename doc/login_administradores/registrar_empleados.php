...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM empleados WHERE username = ?";
    ...
    if(empty($username_err) && empty($nombres_err)&& empty($apellidos_err)&& empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO empleados (nombres, apellidos, username, password) VALUES (?, ?, ?, ?)";
                ...
                <div class="caja1">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="formtlo ">Registrar Empleados</div>

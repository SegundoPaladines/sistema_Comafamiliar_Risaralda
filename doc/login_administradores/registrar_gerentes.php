...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM gerentes WHERE username = ?";
    ...
    if(empty($username_err) && empty($nombres_err)&& empty($apellidos_err)&& empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO gerentes (nombres, apellidos, username, password) VALUES (?, ?, ?, ?)";
...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
     <title>Registrar Gerentes</title>
            ...
            <div id="log">
                <div class="caja1">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="formtlo ">Registrar Gerentes</div>

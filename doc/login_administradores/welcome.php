                ...
                <td width="50%">
                    ...
                    <div width="100%">
                        <table id="actividades" width="100%">
                            ...
                            <tr>
                                <td width="100%">
                                    <a href="registrar_empleados.php"><div class="actividad">
                                        <table width="100%">
                                            <tr>
                                                <td width="60%">
                                                    Registrar Empleados
                            ...
                            <tr>
                                <td width="100%">
                                    <a href="registrar_gerentes.php"><div class="actividad">
                                        <table width="100%">
                                            <tr>
                                                <td width="60%">
                                                    Registrar Gerentes
                            ...
                            <tr>
                                <td width="100%">
                                    <a href="registrar_admins.php"><div class="actividad">
                                        <table width="100%">
                                            <tr>
                                                <td width="60%">
                            ...
                            <tr>
                                <td width="100%">
                                    <a href="eliminar_usuarios.php"><div class="actividad">
                                        <table width="100%">
                                            <tr>
                                                <td width="60%">
                                                    Eliminar Usuarios

...
<div id="relleno_2"></div>
    <center>
        <div id="p_c">
            <center><div id="contenedor_tabla_empleados">
            ...
            <center><table id="empleados" class="emp">
                ...
                $id=$_SESSION["id"];
                $empleados="SELECT*  FROM `empleados` WHERE id NOT LIKE '$id'";
                ...
                ?>
                    <tr>
                        ...
                        <td width="15%">
                            <div id="link">
                                <a href="actualizar_empleados.php?id=<?php echo $row["id"];?>">Realizar Critica</a>
                            </div>
                        </td>
                    </tr>
                <?php
                ...
                ?>
                    <tr>
                        ...
                        <td width="15%">
                            <div id="link">
                                <a href="actualizar_gerentes.php?id=<?php echo $row["id"];?>">Realizar Critica</a>
                            </div>
                        </td>
                    </tr>
                <?php
                ...
                ?>
                    <tr>
                        ...
                        <td width="15%">
                            <div id="link" >
                                <a href="actualizar_admins.php?id=<?php echo $row["id"];?>">Realizar Critica</a>
                            </div>
                        </td>
                    </tr>
                <?php
 ...
 <!--Llamado al scrip del slider-->
 <script src="/doc/login_empleados/js/buscador.js"></script>
</body>
<fotter>
    <div id="pie_pagina">

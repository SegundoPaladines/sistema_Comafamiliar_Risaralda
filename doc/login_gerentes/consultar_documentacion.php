...
<body>
    ...
    <center>
        <div id="p_c">
            ...
            <div><input class="buscador" data-table="doc" type="text" placeholder="Buscar Documento"></div>
            <center><table id="empleados" class="doc">
                <thead>
                    <th width="20%">
                        Nombre Documento
                    </th>
                    ...
                    <tr>
                        ...
                        <td width="20%">
                            <div>
                                <?php
                                    $link=$row["ruta"];
                                    echo "<a href='".$link."' target='_blank'>Consultar</a>";
                                ?>
                            </div>
                        </td>
                    </tr>

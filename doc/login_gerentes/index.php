...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, nombres, apellidos, username, password FROM gerentes WHERE username = ?";
    ...
    <div id="menu_encabezado">
            <table id="barra_log-in_usuarios">
                <tr>
                    ...
                    <td width="8%">
                        <a href="/doc/login_empleados/index.php" target="blank"><div id="user_empleado">
...
<table id="log-contenido">
    <tr>
        <td width="75%">
            <div id="info">
               <img src="/doc/img/gerente.png" width="100%">
            </div>
        </td>
        <td>
            <div id="log">
                <div class="caja1">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                            ...
                            <div class="formtlo ">Iniciar sesión: Gerente</div>
